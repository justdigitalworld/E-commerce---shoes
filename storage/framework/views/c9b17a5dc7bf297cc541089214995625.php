...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'w-full justify-center py-3 text-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full justify-center py-3 text-lg']); ?>
...
<?php endif; ?>
        ...
        <div class="mt-6 flex flex-col items-center space-y-3">
            ...
            <?php if(Route::has('register')): ?>
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH D:\ems\resources\views/auth/login.blade.php ENDPATH**/ ?>