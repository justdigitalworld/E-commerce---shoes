                    ...
                    <div class="sm:text-center lg:text-left lg:w-1/2 relative z-20">
                        ...
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start animate-fade-in-up animation-delay-400">
                            <div class="rounded-md shadow">
                                <a href="<?php echo e(route('shop.index')); ?>" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-white bg-blue-600 hover:bg-blue-700 md:py-4 md:text-lg md:px-10 transition-all transform hover:scale-105 shadow-lg hover:shadow-blue-500/50">
                                    Shop Now
                                </a>
                            </div>
                        </div>
        ...
        <div class="absolute inset-0 w-full h-full lg:w-1/2 lg:left-1/2 overflow-hidden">
            ...
            <div id="hero-slider" class="relative w-full h-full">
                ...
                <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-100 slide-item transform scale-105 animate-slow-zoom">
                    <img class="w-full h-full object-cover" src="<?php echo e(asset('images/Men.png')); ?>" alt="Men's Collection">
                </div>
                <!-- Slide 2 -->
                <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-0 slide-item transform scale-105 animate-slow-zoom">
                    <img class="w-full h-full object-cover" src="<?php echo e(asset('images/Women.png')); ?>" alt="Women's Collection">
                </div>
                <!-- Slide 3 -->
                <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-0 slide-item transform scale-105 animate-slow-zoom">
                    <img class="w-full h-full object-cover" src="<?php echo e(asset('images/Kids.png')); ?>" alt="Kids' Collection">
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative rounded-2xl overflow-hidden group shadow-2xl hover:shadow-3xl transition-all duration-500 h-96">
                        ...
                        ?>
                        <img src="<?php echo e($image); ?>" alt="<?php echo e($category->name); ?>" class="w-full h-full object-cover transform group-hover:scale-110 transition duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8">
                            <h3 class="text-3xl font-bold text-white mb-2 transform translate-y-4 group-hover:translate-y-0 transition duration-300"><?php echo e($category->name); ?></h3>
                        ...
                        <a href="<?php echo e(route('shop.index', ['category' => $category->slug])); ?>" class="absolute inset-0 z-20"></a>
                    </div>
    ...
    <div class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <?php $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group relative bg-white border border-gray-100 rounded-2xl flex flex-col overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div class="aspect-w-1 aspect-h-1 bg-gray-100 group-hover:opacity-90 relative overflow-hidden h-64">
                             ...
                             ?>
                             <img src="<?php echo e($productImage); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-center object-cover transition duration-500 group-hover:scale-105">
                        ...
                        <div class="flex-1 p-6 flex flex-col justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mb-2"><?php echo e($product->category->name); ?></p>
                            </div>
                            <div class="flex items-center justify-between mt-4">
                                <p class="text-xl font-extrabold text-blue-600">$<?php echo e(number_format($product->price, 2)); ?></p>
            ...
            <div class="mt-16 text-center">
                <a href="<?php echo e(route('shop.index')); ?>" class="btn-primary inline-flex items-center">
                    View All Products 
...
<?php echo $__env->make('layouts.shop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ems\resources\views/frontend/home/index.blade.php ENDPATH**/ ?>