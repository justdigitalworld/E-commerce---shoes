...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-blue-600 text-white p-6 rounded-xl shadow-md border-b-4 border-blue-800">
            ...
            <a href="{{ route('admin.users.index') }}" class="mt-4 block text-sm font-medium hover:underline">View all users →</a>
        </div>
        ...
        <div class="bg-emerald-600 text-white p-6 rounded-xl shadow-md border-b-4 border-emerald-800">
            ...
            <a href="{{ route('admin.products.index') }}" class="mt-4 block text-sm font-medium hover:underline">Manage products →</a>
        </div>
        ...
        <div class="bg-amber-600 text-white p-6 rounded-xl shadow-md border-b-4 border-amber-800">
            ...
            <a href="{{ route('admin.orders.index') }}" class="mt-4 block text-sm font-medium hover:underline">View orders →</a>
        </div>
    </div>
    ...
    <div class="mt-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="{{ route('admin.products.create') }}" class="flex items-center p-4 bg-white rounded-lg shadow border border-gray-100 hover:border-blue-400 hover:shadow-md transition-all group">
            ...
            <a href="{{ route('admin.categories.create') }}" class="flex items-center p-4 bg-white rounded-lg shadow border border-gray-100 hover:border-green-400 hover:shadow-md transition-all group">
            ...
            <a href="{{ route('admin.orders.index') }}" class="flex items-center p-4 bg-white rounded-lg shadow border border-gray-100 hover:border-amber-400 hover:shadow-md transition-all group">
            ...
            <a href="{{ route('home') }}" target="_blank" class="flex items-center p-4 bg-white rounded-lg shadow border border-gray-100 hover:border-purple-400 hover:shadow-md transition-all group">
